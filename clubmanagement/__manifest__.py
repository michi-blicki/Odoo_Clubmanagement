...
Long description of module's purpose
    ...
    'data': [
        ...
        'data/club_member_state_rule_mail_templates.xml',
        ...
        'views/club_88_view_member_state_rule_dry_run_wizard.xml',
        'views/club_89_view_member_state_change_wizard.xml',
    ...
    'assets': {
        'web.assets_backend': [
            ...
            'clubmanagement/static/src/js/club_member_state_statusbar_patch.js',
        ],
    },
