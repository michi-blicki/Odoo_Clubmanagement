...
class ResConfigSettings(models.TransientModel):
    ...
    club_age_of_majority = fields.Integer(string=_("Age of Majority"), config_parameter="clubmanagement.age_of_majority")
    start_member_id = fields.Integer(string=_("Start Member ID"), config_parameter="clubmanagement.start_member_id")
    start_member_id_set = fields.Boolean(string=_("Start Member ID set"), compute='_compute_start_member_id_set')
